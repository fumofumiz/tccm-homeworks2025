...
Contains: sparse_module.f90,sparse.f90,sparse.
...
This is the executable generated from the `sparse.f90` main program. 

---

### Directory: `Matrices/`

This directory contains the input sparse matrices used by the program.
